...
const ApprovedUsers = () => {
    ...
    const getApprovedUser = async () => {
        try {
            ...
            const response = await axios.get(`${import.meta.env.VITE_BASE_URL}/users/approved-request`, {}, {});
                    ...
                    requests.map((item, index) => (
                        ...
                        >
                            <div className="flex lg:flex-row flex-col     items-start  i gap-4 flex-wrap">
                                <h3 className='text-green-500 p-2 rounded-md bg-green-500/20 text-sm'>Approved</h3>
                            ...
                            <div className="flex items-center gap-3">
                                <div onClick={() => {
                                    handleUserStatus(item._id, 'denied');
                                }} className="cursor-pointer text-red-500 rounded-full p-2 text-xl dark:hover:bg-zinc-700 hover:bg-zinc-300 dark:bg-zinc-900 bg-white">
                                    <IoMdClose size={24} />
                                </div>
